...
#下载相关资源
log4c="log4cplus-1.2.1.tar.gz"
[ ! -f $log4c ] && wget -c -O $log4c https://sourceforge.net/projects/log4cplus/files/log4cplus-stable/1.2.1/log4cplus-1.2.1.tar.gz/download  &
...
[ ! -f sh/conda3.sh ] && wget -c -O sh/conda3.sh https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Anaconda3-5.3.0-Linux-x86_64.sh
